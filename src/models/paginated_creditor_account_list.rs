...
pub struct PaginatedCreditorAccountList {
    ...
    pub results: Option<Vec<crate::models::CreditorAccount>>,
}

impl PaginatedCreditorAccountList {
    pub fn new() -> PaginatedCreditorAccountList {
