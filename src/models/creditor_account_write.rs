...
pub struct CreditorAccountWrite {
    /// Unique entry ID
    ...
    pub address_country: Option<crate::models::CreditorAccountWriteAddressCountryEnum>,
...
impl CreditorAccountWrite {
    /// Creditor account write serializer.
    pub fn new(name: String, account: String, currency: String) -> CreditorAccountWrite {
