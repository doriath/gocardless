...
pub async fn create_requisition(configuration: &configuration::Configuration, requisition_request: crate::models::RequisitionRequest) -> Result<crate::models::SpectacularRequisition, Error<CreateRequisitionError>> {
